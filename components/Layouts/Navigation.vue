    ...
    <div class="navigation__container">
      <div class="navigation__content">
          ...
          <div class="navigation__icon">
            ...
            >
              <path
                ...
                transform="translate(-14.4 -14.2)"
              ></path>
            </svg>
          </div>
          <div class="navigation__name">Store</div>
        </div>
        ...
        <div class="navigation__item">
          <div class="navigation__icon">
            ...
            >
              ...
              <path
                ...
                transform="translate(-776.52 -1241.44)"
              ></path>
              <ellipse cx="121.99" cy="31.05" rx="7.16" ry="6.66"></ellipse>
              <path
          ...
          <div class="navigation__name">Games</div>
        </div>
        ...
        <div class="navigation__item">
          ...
          <div class="navigation__name">Nodes</div>
        </div>
      </div>
    </div>
  </div>
